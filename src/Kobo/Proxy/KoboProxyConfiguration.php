...
class KoboProxyConfiguration
{
    ...
    public const KOBO_STOREAPI_URL_SAFE = 'https://books-proxy.while.ch';
    public const KOBO_IMAGEHOST_URL_SAFE = 'https://books-proxy.while.ch';
    ...
    private bool $isDebugHar = false;

    public function __construct(string $harDirectory)
    {
        $this->harDirectory = $harDirectory;
    }
    ...
    public function isDebugHar(): bool
    {
    ...
    public function getHarDirectory(): string
    {
        return $this->harDirectory;
    }
    ...
    public function isBlacklistedForRedirect(RequestInterface|ServerRequestInterface $psrRequest): bool
    {
        return false;
    }

    public function setIsDebugHar(bool $isDebugHar): KoboProxyConfiguration
    {
        $this->isDebugHar = $isDebugHar;
